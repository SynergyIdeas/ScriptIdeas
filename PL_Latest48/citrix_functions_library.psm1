...
function Set-Autologon {
   ...
   try {
       ...
       Set-ItemProperty -Path $AutoLogonPath -Name "DefaultPassword" -Value $PlainPassword -Force
...
"@
                    ...
                    $null = & "diskpart" /s create_vhdx.txt 2>&1
...
Export-ModuleMember -Function @(
   ...
   'Invoke-WithRetry', 'Test-Configuration', 'Write-ProgressHelper', 'Get-SecureCredential', 'Test-ValidInput'
)