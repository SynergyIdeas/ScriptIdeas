...
function Start-SystemDriveDefragmentation {
    ...
    try {
        Write-Log "Starting optional system drive defragmentation for VDI template optimization..." "INFO"
...
function Remove-GhostDevices {
    ...
    try {
        Write-Log "Starting ghost device removal for VDI template optimization..." "INFO"
