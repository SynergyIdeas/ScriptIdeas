...
try {
    ...
    $Stage2NetworkPath = Get-ConfigValue "Stage2ScriptNetworkPath" "\\fileserver\citrix\scripts\citrix_stage2_script.ps1"
    ...
    try {
        ...
        $ConfigSaved = Save-InstallationConfiguration -Config $InstallConfig -ConfigPath "C:\temp\CitrixConfig.json"
