            ...
            if ($Result.Success) {
                ...
                if ($Result.ExitCode) { 
                    ...
                    if ($ExitCodeInfo.RequiresReboot) {
                        $detailsHTML += "<div class='detail-item detail-warning'>⚠️ Reboot Required: $($ExitCodeInfo.RebootReason)</div>"
                    }
                    if ($ExitCodeInfo.IsSuccess) {
                        $detailsHTML += "<div class='detail-item detail-success'>✓ Installation Status: $($ExitCodeInfo.Status)</div>"
                    }
                }
