...
"@
            ...
            if (-not $VHDXCreated) {
                ...
                foreach ($SubDir in $CacheSubDirs) {
                    $SubDirPath = Join-Path $CacheDir $SubDir
                ...
                $SparseFile = Join-Path $CacheDir "cache_reserve.dat"
                try {
                ...
                $VHDXCreated = $true
                Write-Log "Directory-based cache created successfully at: $CacheDir" "SUCCESS"
            }
