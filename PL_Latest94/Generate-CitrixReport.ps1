    ...
    switch ($ComponentName) {
        ...
        "DomainJoin" {
            if ($Result.Success) {
                ...
                $detailsHTML += '<div class="detail-section">'
                $detailsHTML += '<div class="detail-section-title">Domain Configuration</div>'
                if ($Result.DomainName) { $detailsHTML += "<div class='detail-item detail-info'>Domain: $($Result.DomainName)</div>" }
                if ($Result.ComputerName) { $detailsHTML += "<div class='detail-item detail-info'>Computer: $($Result.ComputerName)</div>" }
                $detailsHTML += '<div class="detail-item detail-info">Authentication: Kerberos enabled</div>'
                $detailsHTML += '<div class="detail-item detail-info">Group Policy: Domain policies will apply after reboot</div>'
                $detailsHTML += '<div class="detail-item detail-info">Status: Reboot required to complete domain join</div>'
                $detailsHTML += '</div>'
            } elseif ($Result.Skipped) {
                $detailsHTML += '<div class="detail-section">'
        ...
        "VDA Verification" {
            if ($Result.Success) {
                ...
                $detailsHTML += '<div class="detail-item detail-success">[SUCCESS] System readiness for Stage 2 operations</div>'
                $detailsHTML += '</div>'
            } else {
                $detailsHTML += '<div class="detail-section">'
        ...
        "Citrix Services" {
            if ($Result.Success) {
                ...
                $detailsHTML += '<div class="detail-item detail-success">[SUCCESS] Platform readiness confirmed</div>'
                $detailsHTML += '</div>'
            } else {
                $detailsHTML += '<div class="detail-section">'
        ...
        "System Readiness" {
            if ($Result.Success) {
                $detailsHTML += '<div class="detail-section">'
                $detailsHTML += '<div class="detail-section-title">System Readiness Assessment</div>'
                $detailsHTML += '<div class="detail-item detail-success">[SUCCESS] System readiness assessment completed</div>'
                if ($Result.Percentage) {
                    $detailsHTML += "<div class='detail-item detail-success'>Readiness percentage: $($Result.Percentage)%</div>"
                }
                if ($Result.Score -and $Result.MaxScore) {
                    $detailsHTML += "<div class='detail-item detail-info'>Readiness score: $($Result.Score)/$($Result.MaxScore)</div>"
                }
                $detailsHTML += '<div class="detail-item detail-success">[SUCCESS] VDI template preparation validated</div>'
                $detailsHTML += '<div class="detail-item detail-success">[SUCCESS] Deployment readiness confirmed</div>'
                $detailsHTML += '</div>'
            } else {
                $detailsHTML += '<div class="detail-section">'
                $detailsHTML += '<div class="detail-section-title">System Readiness Issues</div>'
                $detailsHTML += "<div class='detail-item detail-error'>[ERROR] System readiness assessment encountered issues</div>"
                if ($Result.Percentage) {
                    $detailsHTML += "<div class='detail-item detail-warning'>Readiness percentage: $($Result.Percentage)%</div>"
                }
                if ($Result.Issues) {
                    foreach ($Issue in $Result.Issues) {
                        $detailsHTML += "<div class='detail-item detail-warning'>Issue: $Issue</div>"
                    }
                }
                $detailsHTML += '</div>'
            }
...
function New-CitrixReport {
    ...
    $ComponentDisplayNames = @{
        ...
        'Active Setup Components Cleanup' = 'Active Setup Components Cleanup'
        'System Readiness' = 'System Readiness Assessment'
    }
