...
function New-CitrixReport {
    ...
    $HTML += '.header-title { font-size: 36px; font-weight: 800; color: #1e293b; margin: 0; text-align: center; }'
    ...
    if ($Stage -eq 1) {
        ...
        $HTML += '<div class="card" style="margin-bottom: 24px; background: #3C1053; border-color: #3C1053;">'
        $HTML += '<div class="card-header">'
        $HTML += '<div class="card-title" style="color: white;">Next Steps Required</div>'
        $HTML += '</div>'
        $HTML += '<div style="color: white; font-weight: 500; line-height: 1.6;">'
