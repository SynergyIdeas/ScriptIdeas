...
function Export-WEMPolicyToXML {
    ...
    try {
        ...
        Write-Host "WEM policy exported to $OutputPath"
        return $OutputPath
    }
    catch {
...
function Compare-WEMWithGPO {
    ...
    try {
        ...
        Write-Host "Comparison results saved to $OutputXmlPath"
...
Export-ModuleMember -Function Export-WEMPolicyToXML, Compare-WEMWithGPO, Get-WEMPolicyTemplates
