...
function Start-CitrixOptimizer {
   ...
   try {
       ...
       # Load configuration parameters - use cached values if available, otherwise read from config file
       if ($Global:CachedConfig -and $Global:CachedConfig.CitrixOptimizerPath) {
           Write-Log "Using cached Citrix Optimizer configuration values" "INFO"
           ...
           $OptimizerMode = "Execute"
       } else {
           Write-Log "Using configuration file for Citrix Optimizer settings" "INFO"
